...
namespace WebApiExamples
{
    public class WebApiExamples
    {
        ...
        private static async void TestCsdApiWeb(FacturamaApi facturama)
        {
            ...
            try
            {
                var csdResponse = facturama.TaxEntities.UploadCsd(csdRequest);
                Console.WriteLine(csdResponse.SerialNumber);
                Console.WriteLine(csdResponse.ExpirationDate);
                Console.WriteLine(csdResponse.Certificate);
