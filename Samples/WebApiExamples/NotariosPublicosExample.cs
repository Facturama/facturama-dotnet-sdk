    ...
    public class NotariosPublicosExample
    {
        ...
        public void Run()
        {
            try
            {
                ...
                TestNotariosPubliscosConCoproSocConyugalE(facturama);
            }
        ...
        public void TestNotariosPubliscosConCoproSocConyugalE(FacturamaApi facturama)
        {
            Console.WriteLine("----- Inicio del ejemplo Notarios Publicos con CoproSocConyugalE -----");
            ...
            cfdi.Complement = new Facturama.Models.Complement()
            {
                NotariosPublicos = new NotariosPublicos
                {
                    ...
                    DatosEnajenante = new DatosEnajenante
                    {
                        ...
                        Item = new Facturama.Models.Complements.NotariosPublicos.Item
                        {
                            DatosEnajenanteCopSC = new List<DatosEnajenanteCopSC>
                           {
                               new DatosEnajenanteCopSC
                               {
                                   Nombre = "Juan",
                                   ApellidoPaterno = "Perez",
                                   RFC = "KICR630120NX3",
